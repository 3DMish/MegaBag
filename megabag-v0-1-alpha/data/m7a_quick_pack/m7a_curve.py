...
def draw_properties(self, context, lc_main):
    ...
    lc_main_row.prop(obj.data.splines.active, "use_cyclic_u", text="Cyclic U", toggle=True);
    lc_main_row.prop(obj.data.splines.active, "resolution_u", text="");
...
#        lc_col.operator("object.shape_key_add", icon='ADD', text="").from_mix = False;
#        lc_col.operator("object.shape_key_remove", icon='REMOVE', text="").all = False;
